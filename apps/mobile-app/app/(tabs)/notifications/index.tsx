...
export default function NotificationsScreen() {
  ...
  const handleNotificationPress = useCallback(
    async (notification: any, assignmentId: string) => {
      try {
        ...
        {loading ? (
          ...
          notifications.map((notification) => (
            <NotificationItem
              ...
              onPress={() =>
                handleNotificationPress(notification, notification.assignmentId || notification.id)
              } // Sử dụng assignmentId nếu có, nếu không thì dùng id
              onDelete={() =>
                handleDeleteNotification(notification.assignmentId || notification.id)
              }
            />
          ))
        ) : (
