                ...
                <View style={styles.orderCardHeader}>
                  <View style={styles.orderHeaderLeft}>
                    <View
                      style={[
                        styles.statusBadge,
                        { backgroundColor: STATUS_COLORS[getOrderStatus(order) as keyof typeof STATUS_COLORS] },
                      ]}
                    >
                  ...
                  {order.orderItems && order.orderItems.length > 0 ? (
                    order.orderItems.map((item) => (
                        ...
                        <View style={styles.orderItemDetails}>
                            ...
                            <View style={[styles.itemStatusBadge, { backgroundColor: STATUS_COLORS[item.status as keyof typeof STATUS_COLORS] }]}>
