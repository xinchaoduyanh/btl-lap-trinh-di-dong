...
const CheckInOutScreen = ({ navigation }: CheckInOutScreenProps) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header title="Attendance" onBackPress={() => navigation.goBack()} />
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.checkInOutContainer}>
          ...
          <TouchableOpacity
            style={[styles.checkInOutButton, { backgroundColor: isCheckedIn ? "#F44336" : "#4CAF50" }]}
